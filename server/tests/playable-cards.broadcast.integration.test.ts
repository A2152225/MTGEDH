...
describe('broadcastGame playable card refresh', () => {
  ...
  it('does not highlight a hand instant when the only discard mana source would require discarding that spell', () => {
    const gameId = 'playable_cards_discard_self_exclusion';
    const ctx = createContext(gameId);
