...
export function createAbsorbSummary(ability: AbsorbAbility, damage: number): AbsorbSummary {
  const result = resolveAbsorb(ability, damage);

  return {
    source: ability.source,
    absorbValue: ability.count,
